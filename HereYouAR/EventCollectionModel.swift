...
//                self.events.append(contentsOf: events)
    ...
    let eventStubs = [
        ...
        Event(id: 1002,
              ...
              title: "MSU mafia",
              type: .event,
              description: "Mafia game in MSU",
              tags: [Tag(name: "mafia"), Tag(name: "game")],
              startDate: nil,
              endDate: nil,
        ...
        Event(id: 1003,
              ...
              title: "Football",
              type: .event,
              description: "Playing Football in the garden",
              tags: [Tag(name: "football"), Tag(name: "game")],
              startDate: nil,
              endDate: nil,
              participantsLimit: 10,
              participantIds: nil,
        ...
        Event(id: 1004,
              ...
              type: .event,
              description: "Smoke shisha tonight at red october",
              tags: [Tag(name: "shisha"), Tag(name: "chill"), Tag(name: "launge")],
              startDate: nil,
              endDate: nil,
              participantsLimit: 2,
              participantIds: nil,
              score: nil),
        Event(id: 1005,
              longitude: 37.5747451,
              latitude: 55.759755,
              title: "Watch movie",
              type: .event,
              description: "Watch a new film in solovey",
              tags: [Tag(name: "cinema"), Tag(name: "movie")],
              startDate: nil,
              endDate: nil,
              participantsLimit: 5,
              participantIds: nil,
        ...
        Event(id: 1006,
              ...
              title: "Cookies",
              type: .event,
              description: "Eat some cookies on snack point",
              tags: [Tag(name: "food"), Tag(name: "cinema"), Tag(name: "hackathon")],
              startDate: nil,
              endDate: nil,
              participantsLimit: 5,
              participantIds: nil,
